...
//Test Case 3 : for checking if the bid is more than the token amount
...
it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result,'0x0000000000000000000000000000000000000000',"Winner of item 0 is the default address")
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result,'0x0000000000000000000000000000000000000000',"Winner of item 1 is the default address")
      /**********
      TASK 18: Call winners function from account 3 to get the winner of item id 2
      ***********/
      return auctionInstance.winners(1,{from: accounts[3]})
    }).then(function(result) {
      /**********
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result,'0x0000000000000000000000000000000000000000',"Winner of item 2 is the default address")
    })
  });
});

...
contract Deposit{
    ...
    //either receive() of fallback() is mandatory for the contract to receive ETH
    //by sending ETH to the contract's address
    ...
    //transfering ether from the contract address to another address (recipient)
